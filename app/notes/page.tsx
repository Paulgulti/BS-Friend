// 'use client'
// import CustomEditor, { CustomEditorHandle } from '@/components/CustomEditor'
          ...
          {notes && notes.length > 0 ? (
            ...
            <div className='h-screen flex m-auto justify-center items-center'>
              <div className='flex flex-col items-center'>
                <svg viewBox="0 0 1024 1024" className="icon w-20 h-20 animate-bounce" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                  <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                  <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                  <g id="SVGRepo_iconCarrier"><path d="M660 103.2l-149.6 76 2.4 1.6-2.4-1.6-157.6-80.8L32 289.6l148.8 85.6v354.4l329.6-175.2 324.8 175.2V375.2L992 284.8z" fill="#FFFFFF"></path>
                ...
                <p>You haven't created note yet.</p>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="mt-2">
        <button
          ...
          onClick={() => {
            ...
            const text = (editorRef.current?.getText() || '').trimEnd();
            // TODO: replace with your save logic
            console.log('SAVE payload', { html, text });
          }}
        >
          Save
        </button>
