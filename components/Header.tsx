...
const Header = ({ menuOpened, setMenuOpened }: Props) => {
    return (
        <div className="sticky top-0 z-50 p-2 flex justify-between items-center bg-sky-100">
            ...
            <div className={`absolute top-10 left-0 right-0 bg-sky-100 shadow-lg md:hidden flex flex-col gap-2 p-4 z-10 transition-all duration-300 ease-in-out overflow-hidden ${menuOpened
            ...
            <div className="flex">
                <SignedOut>
                    <div className="flex gap-2">
                        <Button asChild className='hover:cursor-pointer hover:bg-gray-600'>
                            <SignUpButton />
                        </Button>
                        <Button asChild className='hover:cursor-pointer hover:bg-gray-600'>
                            <SignInButton />
